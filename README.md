...
The LaTeX version of this project is also available on Overleaf and the .epib version on https://pkoopongithub.github.io/Projekt_Pompeji:  
👉 [Open Overleaf project](https://www.overleaf.com/read/kbkzgjqkfhqv#d0295b) [https://pkoopongithub.github.io/Projekt_Pompeji/](https://pkoopongithub.github.io/Projekt_Pompeji/)
...
Die LaTeX-Version dieses Projekts kann auch direkt auf Overleaf eingesehen werden, die .epub Version ist online auf https://pkoopongithub.github.io/Projekt_Pompeji/:  
👉 [Overleaf-Projekt öffnen](https://www.overleaf.com/read/kbkzgjqkfhqv#d0295b) [https://pkoopongithub.github.io/Projekt_Pompeji/](https://pkoopongithub.github.io/Projekt_Pompeji/)
...
➡️ Beispiele für die Nutzung von EPUB.js finden sich hier: [https://futurepress.github.io/epub.js/examples/](https://futurepress.github.io/epub.js/examples/)
...
This directory contains HTML files and unpacked EPUB content for displaying e-books directly in the browser. The presentation is done using the JavaScript library [epub.js](https://github.com/futurepress/epub.js).

➡️ Examples for using EPUB.js can be found here: [https://futurepress.github.io/epub.js/examples/](https://futurepress.github.io/epub.js/examples/)

### Usage of `epub.min.js`

The file [`libs/epub.min.js`](./libs/epub.min.js) is a locally stored, minimized version of **epub.js**. This is used to work independently of external servers like `unpkg.com` to ensure long-term availability.
