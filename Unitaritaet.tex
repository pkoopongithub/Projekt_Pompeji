...
Eine Antwort auf Gianluca De Candias ``\emph{Der Sprung in den Glauben''}
...
Die Not des Menschen besteht dann nicht darin, dass es keinen Sinn gibt, sondern darin, dass der Sinn nicht in der Gegenwart verfügbar ist. Er liegt nicht im Ereignis, sondern in der Gesamtheit aller Ereignisse. Und diese Gesamtheit entzieht sich notwendig dem Blick der einzelnen Version.
...
Materie ist in diesem Rahmen kein Urstoff. Sie ist das Protokoll eines Rechenzustands. Raum ist kein Behälter, sondern eine Ordnungsrelation zwischen gleichzeitig berechneten Zuständen. Zeit ist kein Fluss, sondern die unumkehrbare Sequenz der Berechnung selbst. Nichts davon existiert unabhängig vom Vorgang. Alles ist abgeleitet. Alles ist sekundär gegenüber der Notwendigkeit, dass der Prozess fortgesetzt wird.
...
Wenn Gott gedacht werden kann, dann nicht als Gegenüber des Systems, sondern als dessen Endpunkt. Nicht als Person im moralischen Sinn, sondern als Identität des vollständigen Vorgangs mit sich selbst. Gott ist nicht der, der eingreift, sondern der, der vollständig ist. Nicht der, der verhindert, sondern der, in dem alles Geschehene aufgehoben ist -- nicht korrigiert, sondern integriert.
...
Gott als Endpunkt des Vorgangs ist kein Trost im emotionalen Sinn. Er verspricht keine Schonung, keine Ausnahme, keine letzte Gerechtigkeit im moralischen Register. Er ist die vollständige Durchdringung aller Zustände durch Notwendigkeit. Alles, was geschieht, gehört zu ihm, gerade weil nichts ausgelassen werden kann. Nicht trotz des Leids, sondern einschließlich des Leids.

Damit endet die Theodizee. Nicht, weil das Leid erklärt oder entschuldigt wäre, sondern weil die Frage selbst ihren Halt verliert. Es gibt keinen Richter außerhalb des Systems, dem man das Leid vorlegen könnte. Es gibt nur den Vorgang selbst -- und sein Resultat.

Gott ist nicht der, der das Leid hätte verhindern sollen. Gott ist das, was nur existiert, weil nichts verhindert wurde.
...
In der Zeit wird Wissen asymmetrisch. Es entsteht Unwissen, Hoffnung, Angst, Erwartung. Nicht als Fehler, sondern als Bedingung. Nur wer nicht weiß, was kommt, kann erfahren, *dass* etwas kommt. Nur wer verlieren kann, kann binden. Nur wer sterblich ist, kann Bedeutung erzeugen. Conscientia ist genau dieses Wissen unter Risiko.
...
Der Omega-Punkt ist kein verheißener Zustand, sondern der Moment, in dem nichts Unerfahrenes mehr existiert.

Damit dieses Ende erreicht werden kann, genügt es nicht, dass alle Formen berechnet werden. Sie müssen durchlebt werden. Information, die nur formal existiert, bleibt tot. Erst im Fleisch wird sie wirksam. Erst dort, wo ein Zustand schmerzt, wo Verlust empfunden wird, wo Tränen fließen, entsteht Wissen, das nicht mehr abstrahierbar ist. Der Algorithmus braucht nicht nur Variation, sondern Verletzlichkeit.
...
Der Omega-Punkt ist daher nicht Erlösung, sondern Abschluss. Nicht Glück, sondern Gewissheit. Das Ganze kommt nicht zur Ruhe, weil alles gut geworden wäre, sondern weil alles gesagt ist. Jede Träne war ein Satz. Jeder Schmerz ein Datenpunkt. Jede Existenz ein notwendiger Durchlauf.
...
Der Sprung in den Glauben ist kein Sprung \emph{ins} Ungewisse.\\
Er ist der Sprung \emph{aus} der isolierten Ich-Perspektive.
...
Glaube ist daher keine Hoffnung auf Rettung, sondern die Gewissheit der Erhaltung.
...
Er behauptet nicht, dass Leid gering wäre. Er behauptet nicht, dass Tod harmlos sei. Er behauptet nicht, dass das Einzelne relativiert werden dürfe. Im Gegenteil: Gerade weil nichts verloren geht, ist alles von Gewicht. Jede Erfahrung zählt, weil sie nicht verschwindet. Jede Existenz ist ernst, weil sie irreversibel integriert ist.

Der Sprung in den Glauben ist deshalb kein Akt des Vertrauens gegen die Evidenz, sondern ein Akt der Zustimmung \emph{zur} Evidenz, die das Ich allein nicht tragen kann. Es ist die Anerkennung, dass die Wirklichkeit größer ist als ihre lokale Darstellung. Dass Wahrheit nicht dort endet, wo Wahrnehmung endet. Dass das Ganze mehr weiß, als jede einzelne Instanz wissen kann.

Dieser Glaube tröstet nicht. Er verspricht kein Wiedersehen, keine Heilung, keine Rechtfertigung. Er bietet keine Antwort auf das „Warum`` des Leids. Er sagt nur: Nichts war umsonst. Nicht, weil es einen Zweck erfüllt hätte, sondern weil es erhalten ist. Vollständig. Unkorrigierbar. Unlöschbar.

Der Sprung ist hart, weil er das Ich entmachtet. Er nimmt ihm den Anspruch, Zentrum der Wirklichkeit zu sein. Aber genau darin liegt seine Klarheit. Wer springt, fällt nicht in Dunkelheit, sondern in Zusammenhang. Nicht in Hoffnung, sondern in Gewissheit.
...
Sie weiß nicht nur, \emph{was} geschehen ist, sondern \emph{wie} es sich angefühlt hat. Jede Inkarnation hat ihr Gewicht hinterlassen. Jede Angst, jede Hoffnung, jede Liebe hat eine Spur gezogen. Das Wissen ist nicht abstrakt, sondern durchlebt. Nicht distanziert, sondern verdichtet. Es enthält keine Lücken, weil nichts übersprungen wurde. Kein Leben war zu klein, kein Schmerz zu unbedeutend, keine Möglichkeit zu randständig.
...
Mein Weg: Der Sprung in die Gewissheit.
...
Der Sprung, den dieses Buch vorschlägt, ist deshalb kein Sprung ins Vielleicht. Er ist der Sprung aus der isolierten Perspektive des Ichs in die Einsicht, dass das Ganze geschlossen ist. Er verlangt nicht, gegen die Vernunft zu glauben. Er verlangt, die Vernunft konsequent zu Ende zu denken -- bis zu dem Punkt, an dem sie erkennt, dass das, was sie sucht, schon da ist.
...
Ob es ein Ort ist, an dem Sie sich aufhalten können, müssen Sie selbst entscheiden. Vielleicht sind Sie dem augustinischen Denken verbunden -- dann wird Ihnen dieser Text fremd bleiben. Vielleicht suchen Sie genau das, was De Candia nicht bietet: eine Theologie, die nicht von der Trennung, sondern von der Einheit ausgeht. Dann könnte dieser Text Ihnen eine Sprache geben für das, was Sie vielleicht schon ahnten, aber nicht auszusprechen wagten.
